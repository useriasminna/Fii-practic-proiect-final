...
makeAPIRequest('GET',url).then(response =>{
    console.log(data)
    ...
    data.results.forEach(movie =>
        {  
             ...
             h2.setAttribute('href','movie-details.html?'+movie.id);
             ...
             yearOfRelease.textContent=' ('+movie.release_date.substr(0,4)+')'
            ...
            makeAPIRequest('GET','https://api.themoviedb.org/3/movie/'+movie.id+'/credits?api_key=71979c8dbee4788fbc86711e4e9106b4').then(response =>{
                console.log(data)
                ...
                makeAPIRequest('GET','https://api.themoviedb.org/3/movie/'+movie.id+'?api_key=71979c8dbee4788fbc86711e4e9106b4&language=en-US').then(response =>{
                    console.log(data)
                    ...
                    makeAPIRequest('GET',' https://imdb-api.com/en/API/Ratings/k_zo09nCxZ/'+data.imdb_id).then(response =>{
                        console.log(data)
                        ...
                        if(data.imDb)
                        {
                             ...
                             imdbscore.setAttribute('href','https://www.imdb.com/title/'+data.imDbId)
                        }
                        else
                        {
...
makeMovieElements('https://api.themoviedb.org/3/movie/top_rated?api_key=71979c8dbee4788fbc86711e4e9106b4&language=en-US&page=1');
makeMovieElements('https://api.themoviedb.org/3/movie/top_rated?api_key=71979c8dbee4788fbc86711e4e9106b4&language=en-US&page=2');
makeMovieElements('https://api.themoviedb.org/3/movie/top_rated?api_key=71979c8dbee4788fbc86711e4e9106b4&language=en-US&page=3');
makeMovieElements('https://api.themoviedb.org/3/movie/top_rated?api_key=71979c8dbee4788fbc86711e4e9106b4&language=en-US&page=4');
makeMovieElements('https://api.themoviedb.org/3/movie/top_rated?api_key=71979c8dbee4788fbc86711e4e9106b4&language=en-US&page=5');
